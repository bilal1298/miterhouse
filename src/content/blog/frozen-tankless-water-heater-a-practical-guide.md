...
## Emergency Response: Your Unit Is Already Frozen
...
Inspect the unit's exterior connections, the inlet and outlet pipes, and the condensate drain (on condensing models) for cracks, bulging, or dripping. If you see water dripping from the unit itself (not from pipe connections), the heat exchanger may already be compromised.
...
**External pipes are NOT protected.** The freeze protection only covers the unit's internal components. The supply and return pipes running to and from the unit are your responsibility. These freeze first and most often.

## Prevention: The Real Solution

Preventing freeze damage costs a fraction of repairing it. Here are the measures that actually work, ranked by effectiveness.

### Install in a Protected Location

The ideal location for a tankless water heater in cold climates is indoors — a utility room, basement, or heated garage. Outdoor installation works in mild climates but is asking for trouble anywhere that sees regular freezing temperatures.

If outdoor installation is unavoidable, use an insulated enclosure rated for your climate zone. These weatherproof boxes range from $100 to $400 and provide both insulation and wind protection.

### Insulate the Pipes

Every inch of water pipe between your heated space and the tankless unit needs insulation. Use closed-cell foam pipe insulation (minimum R-4 for freezing climates) and seal every joint with waterproof tape. Pay special attention to:

- The cold water supply pipe from the house to the unit
- The hot water return pipe from the unit to the house
- The condensate drain line (on condensing units) — this small line freezes easily and backs up into the unit

### Install a Freeze Protection Solenoid Valve

Some manufacturers offer (and recommend for cold climates) a solenoid valve kit that automatically drains the unit's internal water when power is lost or temperatures drop below a threshold. These cost $50 to $150 and provide protection during power outages when the built-in electric freeze protection is offline.

### Battery Backup or UPS

A small uninterruptible power supply (UPS) keeps the unit's freeze protection running during power outages. The freeze protection circuitry draws very little power — 50 to 100 watts — so even a basic UPS ($75 to $200) can maintain protection for 4 to 12 hours, enough to ride out most outages.
